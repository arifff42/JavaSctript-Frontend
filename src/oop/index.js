class Customer {
  //public yerine export kullanılıyor
...
let cartTotal = products.reduce((acc, product)=>acc+ product.unitPrice, 0) //acc = accumulator toplama manasında
